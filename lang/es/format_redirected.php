...
$string['notredirected_error'] = 'Este curso está configurado incorrectamente como "Redirigido" pero no es posible la redirección. Necesita la intervención del profesor o del administrador.';
